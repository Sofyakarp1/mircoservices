...
public class HttpClient {
    ...
    public JSONObject postJsonSing(Client client, String url, String object, String param) throws ParseException {
        ...
        ParseJson parseJson = new ParseJson();
        return parseJson.parseJsonFromServiceSingle(output, param);
    }
}
